...
def parse_args():
    ...
    ps_find = sp.add_parser(
        "find", aliases=["search"], help=find_help, description=find_help
    )
    ...
    ps_rm = sp.add_parser(
        "rm", aliases=["drop", "remove"], help=rm_help, description=rm_help
    )
    ps_rm.add_argument(
    ...
    ps_mv = sp.add_parser(
        "mv", aliases=["rename", "replace"], help=mv_help, description=mv_help
    )
    ps_mv.add_argument(
        "old_group",
        help="The current name of the cooldown group that you want to rename",
    )
    ps_mv.add_argument(
